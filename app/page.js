    ...
    <div style={{ minHeight: "100vh", background: "#F7F3EE", color: "#3A3532", overflowX: "hidden" }}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Rose — primary warm CTA */
        .pill-rose {
          background: linear-gradient(135deg, #C17B84 0%, #A8626A 100%);
          color: #FDF9F6; border-color: transparent;
          box-shadow: 0 4px 18px rgba(168,98,106,0.28);
        }
        .pill-rose:hover {
          background: linear-gradient(135deg, #B06E77 0%, #975A62 100%);
          transform: translateY(-2px);
          box-shadow: 0 10px 32px rgba(168,98,106,0.38);
        }
        /* Olive — secondary */
        .pill-olive {
        ...
        /* Outline rose */
        .pill-outline-rose {
          background: transparent; color: #B06E77; border-color: #C17B84;
        }
        ...
        .nav-link::after {
          ...
          height: 1px; background: linear-gradient(90deg, #C17B84, #B89B72);
          transition: width 0.35s ease;
        }
        .nav-link:hover::after { width: 100%; }
        .nav-link:hover { color: #C17B84; }
        ...
        .drawer-link:hover { color: #C17B84; }
        ...
        .hero-img {
          ...
          box-shadow: 0 32px 80px rgba(58,53,50,0.14), 0 8px 24px rgba(193,123,132,0.1);
        ...
        .prod-card:hover {
          ...
          box-shadow: 0 28px 64px rgba(58,53,50,0.12), 0 4px 16px rgba(193,123,132,0.08);
        }
        ...
        .quiz-option:hover {
          border-color: #C17B84;
          background: linear-gradient(145deg, #FDF4F5 0%, #F5E8E9 100%);
          transform: translateX(4px);
          box-shadow: 0 6px 20px rgba(193,123,132,0.12);
        }
        ...
        .floral-divider::after {
          ...
          background: linear-gradient(90deg, transparent, #C17B84);
        }
        .floral-divider::after {
          background: linear-gradient(90deg, #C17B84, transparent);
        }

        /* ── SECTION TEXTURE HELPERS ── */
        .bg-ivory   { background: #F7F3EE; }
        .bg-linen   { background: linear-gradient(160deg, #EFE7DD 0%, #E8DDD0 100%); }
        .bg-rose-tint { background: linear-gradient(160deg, #FAF0EE 0%, #F2E6E4 100%); }
        ...
        .contact-card:hover {
          ...
          border-color: rgba(193,123,132,0.2);
        }

        /* ── QUOTE BOX ── */
        .quote-box {
          background: linear-gradient(145deg, #FDF4F5 0%, #F5E6E8 100%);
          border-radius: 16px; padding: 24px 28px;
          border-left: 3px solid #C17B84;
      ...
      {/* ── MOBILE STICKY BAR ────────────────────────── */}
      <div className="sticky-bar" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 290, background: "linear-gradient(135deg, #C17B84 0%, #A8626A 100%)", padding: "13px 20px", alignItems: "center", justifyContent: "space-between", boxShadow: "0 -4px 20px rgba(168,98,106,0.2)" }}>
        <p style={{ color: "rgba(255,255,255,0.92)", fontSize: 13, fontWeight: 300, letterSpacing: "0.04em" }}>Intentional wellness tools</p>
        <a href={SHOP_URL} target="_blank" rel="noopener noreferrer" style={{ background: "#FDF9F6", color: "#A8626A", padding: "9px 22px", borderRadius: 100, fontSize: 11, fontWeight: 500, textDecoration: "none", letterSpacing: "0.15em", textTransform: "uppercase", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
          Shop Now →
        </a>
      </div>
      ...
      {/* ── HERO ─────────────────────────────────────── */}
      <section style={{ background: "linear-gradient(160deg, #F7F3EE 0%, #F0E8E6 50%, #EDE4E0 100%)", position: "relative", overflow: "hidden" }} aria-label="Bloom and Co — Where Wellness Meets Purpose">
        {/* Decorative background glow */}
        <div style={{ position: "absolute", top: "-10%", right: "-5%", width: "50%", height: "70%", background: "radial-gradient(ellipse, rgba(193,123,132,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div className="wrap">
          <div className="hero-grid">
            <div className={heroVisible ? "hero-visible" : ""}>
              ...
              <h1 className="serif" style={{ fontSize: "clamp(40px, 7.5vw, 86px)", fontWeight: 300, lineHeight: 0.96, letterSpacing: "-0.02em", color: "#2E2B28" }}>
                ...
                {["Meets", "Purpose"].map((w, i) => (
                  <em key={w} className="hero-word serif" style={{ color: "#C17B84", animationDelay: `${(i + 2) * 0.14}s`, marginRight: i === 0 ? "0.22em" : 0, fontStyle: "italic" }}>{w}</em>
                ))}
              </h1>
            ...
            <div className="hero-img" style={{ transform: "translateZ(0)" }}>
              ...
              <div style={{ position: "absolute", inset: "-8%", background: "radial-gradient(ellipse, rgba(193,123,132,0.14) 0%, transparent 70%)", zIndex: 0, borderRadius: "50%" }} />
              <Image
                src="/hero.png"
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 36, paddingRight: 36 }}>
              {["Wellness Journals", "Flow With Your Cycle", "Corporate Wellness", "Mindful Living", "Kids Coloring Books", "Intentional Growth", "Nairobi, Kenya", "Bloom & Co"].map((item, j) => (
                <span key={j} style={{ fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 36, opacity: 0.6 }}>
                  {item}<span style={{ color: "#C17B84", opacity: 0.6, fontSize: 8 }}>✦</span>
                </span>
              ))}
            </div>
          ))}
          ...
          <div className="two-col">
            ...
            <div>
              ...
              <h2 className="serif sh" style={{ marginBottom: 22 }}>
                Wellness Is The<br />Foundation of<br /><em style={{ color: "#C17B84" }}>Sustainable Growth</em>
              </h2>
      ...
      <section className="sp" style={{ background: "linear-gradient(160deg, #4A4540 0%, #3A3532 100%)", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: 0, right: 0, width: "40%", height: "100%", background: "radial-gradient(ellipse at 80% 30%, rgba(193,123,132,0.07) 0%, transparent 60%)", pointerEvents: "none" }} />
        <div className="wrap">
          <div className="section-header">
            <span style={{ display: "block", fontSize: 10, letterSpacing: "0.42em", textTransform: "uppercase", color: "#C17B84", marginBottom: 18, fontWeight: 400 }}>What's Inside</span>
            <h2 className="serif sh" style={{ color: "#F7F3EE" }}>
              A Look Inside the<br /><em style={{ color: "#C17B84" }}>Corporate Wellness Journal</em>
            </h2>
            <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px auto 0", width: "fit-content" }}>
              <div style={{ width: 36, height: 1, background: "rgba(193,123,132,0.4)" }} />
          ...
          <div className="peek-grid">
            {peekItems.map((item, i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: "28px 24px", transition: "all 0.35s ease" }}
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(193,123,132,0.09)"; e.currentTarget.style.borderColor = "rgba(193,123,132,0.28)"; e.currentTarget.style.transform = "translateY(-4px)"; }}
              ...
              >
                ...
                <div style={{ width: 28, height: 1, background: "linear-gradient(90deg, #C17B84, #B89B72)", marginBottom: 12, borderRadius: 2 }} />
        ...
        <div className="wrap">
          <div className="section-header">
            ...
            <h2 className="serif sh">
              Tools for Every<br /><em style={{ color: "#C17B84" }}>Season of Your Life</em>
            </h2>
          ...
          <div style={{ display: "flex", gap: 8, justifyContent: "center", marginBottom: 48, flexWrap: "wrap" }}>
            {[{ key: "wellness", label: "Wellness & Productivity", emoji: "🌿" }, { key: "kids", label: "Mindful Kids", emoji: "🧸" }].map(tab => (
              <button key={tab.key} onClick={() => setProductTab(tab.key)} style={{
                ...
                borderColor: productTab === tab.key ? "#C17B84" : "#DDD5CA",
                background: productTab === tab.key ? "linear-gradient(135deg, #C17B84 0%, #A8626A 100%)" : "transparent",
                color: productTab === tab.key ? "#FDF9F6" : "#7A6F6A",
                fontSize: 12, letterSpacing: "0.1em", cursor: "pointer",
                fontFamily: "'Jost', sans-serif", transition: "all 0.28s ease",
                textTransform: "uppercase",
                boxShadow: productTab === tab.key ? "0 4px 16px rgba(168,98,106,0.25)" : "none",
              }}>
                {tab.emoji} {tab.label}
              </button>
            ))}
            ...
            {displayProducts.map((product, i) => (
              <div key={i} className="prod-card">
                <div className="prod-img-wrap">
                  ...
                  {product.badge && (
                    <div style={{ position: "absolute", top: 14, left: 14, background: "linear-gradient(135deg, #C17B84 0%, #A8626A 100%)", color: "#FDF9F6", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", padding: "5px 14px", borderRadius: 100, boxShadow: "0 3px 12px rgba(168,98,106,0.3)", zIndex: 2 }}>
                      {product.badge}
                    </div>
                  )}
                ...
                <div style={{ padding: "24px 24px 28px", display: "flex", flexDirection: "column", flexGrow: 1 }}>
                  <p style={{ fontSize: 9, letterSpacing: "0.26em", textTransform: "uppercase", color: "#C17B84", marginBottom: 8, opacity: 0.85 }}>
                    {product.subtitle}
                  </p>
                  ...
                  <ul style={{ listStyle: "none", marginBottom: 20, display: "flex", flexDirection: "column", gap: 6 }}>
                    {product.features.map((f, fi) => (
                      <li key={fi} style={{ fontSize: 12, color: "#7A756F", display: "flex", alignItems: "center", gap: 9 }}>
                        <span style={{ color: "#C17B84", fontWeight: 600, fontSize: 12, flexShrink: 0 }}>✓</span> {f}
                      </li>
                    ))}
                  </ul>
      ...
      <section id="values" className="sp" style={{ background: "linear-gradient(160deg, #3D3A36 0%, #2E2B28 100%)", color: "#F7F3EE", position: "relative", overflow: "hidden" }}>
        ...
        <div className="wrap">
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 className="serif sh" style={{ color: "#F7F3EE" }}>Built on Principles<br /><em style={{ color: "#C17B84" }}>That Matter</em></h2>
          </div>
          <div ref={valuesRef}>
            {values.map((v, i) => (
              <div key={v.label}
                ...
                <span style={{ fontSize: 10, color: "#C17B84", letterSpacing: "0.12em", paddingTop: 4, opacity: 0.8 }}>0{i + 1}</span>
                <div>
      ...
      {/* ── QUIZ ─────────────────────────────────────── */}
      <section id="quiz" className="sp" style={{ background: "linear-gradient(160deg, #FAF0EE 0%, #F2E6E4 50%, #EFE7DD 100%)", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "-10%", right: "-5%", width: "50%", height: "70%", background: "radial-gradient(ellipse, rgba(193,123,132,0.07) 0%, transparent 65%)", pointerEvents: "none" }} />
        <div className="wrap">
          <div style={{ maxWidth: 840, margin: "0 auto", textAlign: "center" }}>
            <span className="label">Wellness Experience</span>
            <h2 className="serif sh" style={{ color: "#2E2B28", marginBottom: 20 }}>
              What Kind of <em style={{ color: "#C17B84" }}>Bloom Are You?</em>
            </h2>
            ...
            {quizStarted && !quizResult && (
              <div style={{ background: "linear-gradient(145deg, #FDFAF7 0%, #F5EEE6 100%)", borderRadius: 24, padding: "36px 28px", boxShadow: "0 12px 48px rgba(58,53,50,0.08)", border: "1px solid rgba(221,213,202,0.8)", textAlign: "left", animation: "fadeUp 0.4s ease" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, marginBottom: 32 }}>
                  <span style={{ fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: "#C17B84", opacity: 0.8 }}>
                    0{quizIndex + 1} — 08
                  </span>
                  <div style={{ flex: 1, maxWidth: 160, height: 2, background: "#DDD5CA", borderRadius: 100, overflow: "hidden" }}>
                    <div style={{ height: "100%", width: `${((quizIndex + 1) / bloomQuestions.length) * 100}%`, background: "linear-gradient(90deg, #C17B84, #B89B72)", transition: "width 0.5s ease" }} />
                  </div>
                </div>
                ...
                <div className="quiz-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  {bloomQuestions[quizIndex].options.map((option, index) => (
                    <button key={index} className="quiz-option" onClick={() => handleBloomAnswer(option.value)}>
                      <span style={{ color: "#C17B84", marginRight: 10, fontWeight: 400, fontSize: 10, letterSpacing: "0.12em", opacity: 0.7 }}>0{index + 1}</span>
                      {option.text}
                    </button>
                  ))}
                </div>
            ...
            {quizResult && (
              <div style={{ background: "linear-gradient(145deg, #FDFAF7 0%, #F5EEE6 100%)", borderRadius: 24, padding: "48px 32px 44px", boxShadow: "0 16px 56px rgba(58,53,50,0.09)", border: "1px solid rgba(221,213,202,0.8)", animation: "fadeUp 0.5s ease" }}>
                <div className="quote-box" style={{ marginBottom: 36 }}>
                  <div style={{ fontSize: 64, color: "#C17B84", lineHeight: 0.8, fontFamily: "Georgia, serif", marginBottom: 10, opacity: 0.22, position: "relative", left: -4 }}>"</div>
                ...
                <div style={{ marginBottom: 28 }}>
                  <p style={{ fontSize: 10, letterSpacing: "0.36em", textTransform: "uppercase", color: "#C17B84", marginBottom: 12, fontWeight: 400 }}>Your energy lately</p>
                  <p style={{ color: "#6B6560", fontSize: 15, lineHeight: 1.9, maxWidth: 560, margin: "0 auto" }}>{quizResult.energy}</p>
                </div>
                <div style={{ width: 40, height: 1, background: "linear-gradient(90deg, #C17B84, #B89B72)", margin: "0 auto 28px", borderRadius: 2 }} />
                <div style={{ background: "rgba(239,231,221,0.7)", borderRadius: 14, padding: "22px 26px", marginBottom: 22, textAlign: "left" }}>
                  <p style={{ fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#A8B29A", marginBottom: 10, fontWeight: 400 }}>A Small Ritual</p>
                  <p style={{ color: "#3A3532", fontSize: 14, lineHeight: 1.8 }}>{quizResult.ritual}</p>
                </div>
                <div style={{ borderLeft: "2px solid #C17B84", paddingLeft: 22, marginBottom: 40, textAlign: "left" }}>
                  <p style={{ fontSize: 10, letterSpacing: "0.32em", textTransform: "uppercase", color: "#C17B84", marginBottom: 8, fontWeight: 400 }}>A Quiet Question</p>
                  <p className="serif" style={{ color: "#6B6560", fontSize: 18, fontStyle: "italic", lineHeight: 1.7, fontWeight: 300 }}>"{quizResult.prompt}"</p>
                </div>
                <p style={{ fontSize: 11, color: "#C17B84", opacity: 0.7, marginBottom: 18, letterSpacing: "0.06em" }}>felt accurate? share it ✦</p>
        ...
        <div className="wrap">
          <div className="two-col two-col-top">
            <div>
              ...
              <h2 className="serif sh" style={{ marginBottom: 22 }}>
                Partnering With<br />Organizations to<br /><em style={{ color: "#C17B84" }}>Cultivate Thriving Teams</em>
              </h2>
            ...
            <div>
              ...
              <div className="offerings-grid">
                {corporateOfferings.map((offer, i) => (
                  <div key={i} style={{ background: "linear-gradient(145deg, #FDF4F5 0%, #F5E6E8 100%)", borderRadius: 12, padding: "14px 18px", fontSize: 13, color: "#5A5550", lineHeight: 1.6, border: "1px solid rgba(193,123,132,0.15)" }}>
                    <span style={{ color: "#C17B84", marginRight: 9, fontWeight: 600 }}>✓</span>{offer}
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="sp" style={{ background: "linear-gradient(160deg, #EFE7DD 0%, #E8DDD0 100%)" }}>
        <div className="wrap">
          <div className="section-header">
            ...
            <h2 className="serif sh">Five Reasons to<br /><em style={{ color: "#C17B84" }}>Choose Bloom & Co</em></h2>
          </div>
          <div className="why-grid">
            ...
            <div style={{ background: "linear-gradient(145deg, #C17B84 0%, #A8626A 100%)", color: "#FDF9F6", borderRadius: 18, padding: "32px", display: "flex", flexDirection: "column", gap: 14, boxShadow: "0 16px 48px rgba(168,98,106,0.25)" }}>
        ...
        <div className="wrap">
          <div className="founder-grid">
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ fontSize: 72, color: "#C17B84", lineHeight: 0.8, fontFamily: "Georgia, serif", marginBottom: 16, opacity: 0.28 }}>"</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                <div style={{ width: 42, height: 42, borderRadius: "50%", background: "linear-gradient(135deg, #C17B84, #A8626A)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "#FDF9F6", letterSpacing: "0.05em", fontFamily: "'Jost', sans-serif", flexShrink: 0 }}>FN</div>
                <div>
      ...
      {/* ── INSTAGRAM ────────────────────────────────── */}
      <section className="sp" style={{ background: "linear-gradient(160deg, #FAF0EE 0%, #F7F3EE 100%)" }}>
        <div className="wrap" style={{ textAlign: "center" }}>
          <span className="label">Follow Along</span>
          <h2 className="serif sh" style={{ marginBottom: 16 }}>Join Us on<br /><em style={{ color: "#C17B84" }}>Instagram</em></h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, maxWidth: 460, margin: "0 auto 40px" }}>
            {["Wellness tips", "Flow With Your Cycle", "Floral Coloring", "Corporate Journal", "Mother's Day", "Kids Coloring"].map((desc, i) => (
              <a key={i} href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
                style={{ aspectRatio: "1/1", background: `linear-gradient(135deg, ${["#EFE7DD,#E5DDD3","#F5E6E8,#EDD8DA","#E5EDE1,#DDE5D8","#EFE7DD,#E5DDD3","#F5E6E8,#EDD8DA","#E5EDE1,#DDE5D8"][i]})`, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 5, textDecoration: "none", overflow: "hidden", transition: "transform 0.3s ease, opacity 0.3s ease" }}
          ...
          <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="pill-btn pill-outline-rose">
            Follow @bloomco.ke
          </a>
        </div>
      </section>
          ...
          <div className="contact-grid">
            <div>
              ...
              <h2 className="serif sh" style={{ marginBottom: 22, lineHeight: 1.05 }}>
                Let's Build<br /><em style={{ color: "#C17B84" }}>Something Together</em>
              </h2>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {contactItems.map((item) => (
                <div key={item.label} className="contact-card">
                  <div style={{ width: 44, height: 44, borderRadius: "50%", background: "linear-gradient(135deg, #FDF4F5, #F5E6E8)", display: "flex", alignItems: "center", justifyContent: "center", color: "#C17B84", flexShrink: 0, fontSize: 18, border: "1px solid rgba(193,123,132,0.15)" }}>
                    {item.icon}
                  </div>
                  <div>
                    <p style={{ fontSize: 9, letterSpacing: "0.32em", textTransform: "uppercase", color: "#C17B84", marginBottom: 4, opacity: 0.85 }}>{item.label}</p>
                    {item.href ? (
            ...
            <div style={{ display: "flex", gap: 24, flexWrap: "wrap", justifyContent: "center" }}>
              {[
                ...
                <a key={l.label} href={l.href} target={l.href.startsWith("http") ? "_blank" : undefined} rel={l.href.startsWith("http") ? "noopener noreferrer" : undefined}
                  ...
                  onMouseEnter={e => e.currentTarget.style.color = "#C17B84"}
